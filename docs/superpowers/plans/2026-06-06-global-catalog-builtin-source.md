# 环球片单 Built-In Source Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Add a `环球片单` built-in source after `豆瓣电影`, exposing the seven supplied media-hub modules through the existing poster grid.

**Architecture:** Add a focused `GlobalCatalogController` and `GlobalCatalogService` that present TVBox-like categories and filters while mapping remote data into `VodItem`. Register the controller/page in `App` and `MainWindow` as a normal built-in tab with key `global_catalog`, leaving `PosterGridPage` unchanged.

**Tech Stack:** Python 3, PySide6, `httpx`, existing `VodItem`/`DoubanCategory`/`CategoryFilter` models, existing pytest/pytest-qt test suite.

---

## File Structure

- Create `src/atv_player/controllers/global_catalog_controller.py`
  - Defines category IDs, filter options, item mapping helpers, a small HTTP/TMDB service, and `GlobalCatalogController`.
- Modify `src/atv_player/ui/main_window.py`
  - Accept `global_catalog_controller`, create `global_catalog_page`, register built-in tab after `douban`, and wire generic context menu/page signals.
- Modify `src/atv_player/app.py`
  - Instantiate `GlobalCatalogController` with `config.metadata_tmdb_api_key` and pass it into `MainWindow`.
- Add `tests/test_global_catalog_controller.py`
  - Unit tests for categories, TMDB mapping, external title resolution, and failure handling.
- Modify `tests/test_main_window_ui.py`
  - Cover tab ordering and built-in tab definitions.

---

### Task 1: Controller Categories and Filters

**Files:**
- Create: `src/atv_player/controllers/global_catalog_controller.py`
- Test: `tests/test_global_catalog_controller.py`
...
Run: `uv run pytest tests/test_global_catalog_controller.py::test_global_catalog_categories_expose_seven_modules_and_representative_filters -v`

Expected: FAIL because `atv_player.controllers.global_catalog_controller` does not exist.

- [ ] **Step 3: Implement the category/controller skeleton**
    ...
    return [
        DoubanCategory(
            ...
            filters=[
                ...
                _filter("cal_day", "选择日期", [("今日更新", "today"), ("周一", "1"), ("周二", "2"), ("周三", "3"), ("周四", "4"), ("周五", "5"), ("周六", "6"), ("周日", "7")]),
                _filter("tmdb_sort", "TMDB 榜单", [("实时流行", "trending"), ("最新首播", "new"), ("高分神作", "top")]),
                _filter("rank_year", "年份", _year_options()),
                _filter("rank_month", "月份/季度", [("全年", "all"), ("冬季", "1"), ("春季", "4"), ("夏季", "7"), ("秋季", "10")]),
            ],
        ),
        DoubanCategory(
            type_id="genre_rank",
            ...
            filters=[
                ...
                _filter("genre", "题材流派", [("全部题材", "all"), ("科幻", "scifi"), ("悬疑", "mystery"), ("恐怖", "horror"), ("犯罪", "crime"), ("动作", "action"), ("喜剧", "comedy"), ("爱情", "romance"), ("剧情", "drama"), ("奇幻", "fantasy"), ("动画", "animation"), ("纪录片", "documentary")]),
                _filter("region", "国家/地区", [("全球", "all"), ("中国大陆", "cn"), ("日本", "jp"), ("韩国", "kr"), ("美国", "us"), ("英国", "gb"), ("欧洲全境", "europe"), ("西语/拉美", "latin")]),
        ...
        DoubanCategory(
            ...
            filters=[
                ...
                _filter("general_sort", "榜单分类", [("流行趋势", "popular"), ("历史高分", "top_rated"), ("全球票房榜", "box_office"), ("奥斯卡佳片", "oscar")]),
                _filter("yearly_sort", "选择年份", _year_options()),
                _filter("genre_sort", "选择类型", [("科幻", "878"), ("剧情", "18"), ("悬疑", "9648"), ("动作", "28"), ("喜剧", "35"), ("爱情", "10749"), ("恐怖", "27"), ("犯罪", "80"), ("奇幻", "14"), ("动画", "16")]),
            ],
        ),
        DoubanCategory(
            type_id="variety",
            type_name="全球综艺频道",
            filters=[
                _filter("sort_by", "国家/地区", [("中国大陆", "cn"), ("韩国", "kr"), ("日本", "jp"), ("中国台湾", "tw"), ("中国香港", "hk"), ("欧美综合", "eu_us"), ("全球综合", "all")]),
                _filter("list_type", "排播与榜单", [("近期热播", "hot"), ("今日更新", "today"), ("明日预告", "tomorrow"), ("流行趋势", "trend"), ("高分神级", "top")]),
            ],
        ),
        DoubanCategory(
            type_id="trends",
            type_name="影剧流行风向",
            filters=[
                _filter("hub_source", "选择平台", [("IMDb 权威榜单", "imdb"), ("烂番茄风向标", "rt"), ("Trakt 趋势榜", "trakt"), ("豆瓣 国内风向", "douban")]),
                _filter("imdb_sort", "IMDb 榜单", [("本周热榜", "trending_week"), ("今日热榜", "trending_day"), ("流行趋势", "popular"), ("高分神作", "top_rated"), ("国产剧热度", "china_tv"), ("国产电影热度", "china_movie")]),
                _filter("mediaType", "范围", [("全部", "all"), ("电影", "movie"), ("剧集", "tv")]),
                _filter("rt_sort", "烂番茄榜单", [("流媒体热映", "rt_movies_home"), ("院线热映", "rt_movies_theater"), ("最佳流媒体", "rt_movies_best"), ("热门剧集", "rt_tv_popular"), ("最新上线", "rt_tv_new")]),
                ...
                _filter("db_sort", "豆瓣榜单", [("热门国产剧", "db_tv_cn"), ("热门综艺", "db_variety"), ("热门电影", "db_movie"), ("热门美剧", "db_tv_us")]),
            ],
        ),
        DoubanCategory(
            type_id="platform",
            ...
            filters=[
                ...
                _filter("platform", "播出平台", [("腾讯视频", "2007"), ("爱奇艺", "1330"), ("优酷", "1419"), ("芒果TV", "1631"), ("Bilibili", "1605"), ("Netflix", "213"), ("Disney+", "2739"), ("HBO", "49"), ("Apple TV+", "2552")]),
        ...
        DoubanCategory(
            ...
            type_name="流媒体 TOP10",
            filters=[
                _filter("region", "榜单地区", [("美国", "united-states"), ("韩国", "south-korea"), ("台湾", "taiwan"), ("香港", "hong-kong"), ("日本", "japan"), ("英国", "united-kingdom"), ("全球", "world")]),
                _filter("platform", "流媒体平台", [("Netflix", "netflix"), ("HBO", "hbo"), ("Disney+", "disney"), ("Apple TV+", "apple-tv"), ("Amazon Prime", "amazon-prime")]),
...
```bash
git add tests/test_global_catalog_controller.py src/atv_player/controllers/global_catalog_controller.py
git commit -m "feat: add global catalog categories"
```

---

### Task 2: TMDB Mapping Service

**Files:**
- Modify: `src/atv_player/controllers/global_catalog_controller.py`
- Modify: `tests/test_global_catalog_controller.py`
...
def test_global_catalog_tmbd_anime_maps_discover_results_to_vod_items() -> None:
...
def test_global_catalog_movie_general_top_rated_uses_tmdb_movie_endpoint() -> None:
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        return httpx.Response(200, json={"total_pages": 1, "results": [{"id": 1, "title": "电影", "release_date": "2025-01-02"}]})
...
Run: `uv run pytest tests/test_global_catalog_controller.py -k "tmbd_anime or movie_general" -v`

Expected: FAIL because `GlobalCatalogService` is not defined.

- [ ] **Step 3: Implement minimal TMDB service and mapper**

Add imports and classes to `src/atv_player/controllers/global_catalog_controller.py` above `GlobalCatalogController`:
...
class GlobalCatalogService:
    ...
    def load_items(
        ...
        try:
            ...
            return [VodItem(vod_id="global_catalog:error", vod_name="环球片单加载失败", vod_content="当前榜单暂时无法获取")], 1
        return [], 0
    ...
    def _load_tmdb_list(self, path: str, *, media_type: str, page: int, params: dict[str, object] | None = None) -> tuple[list[VodItem], int]:
    ...
    def _load_movies(self, page: int, filters: dict[str, str]) -> tuple[list[VodItem], int]:
        ...
        if source == "yearly":
            return self._load_tmdb_list(
                ...
                media_type="movie",
                page=page,
                params={"primary_release_year": filters.get("yearly_sort", "2026"), "sort_by": "vote_average.desc", "vote_count.gte": 500},
            )
        if source == "genre":
            return self._load_tmdb_list(
                "/discover/movie",
        ...
        if sort == "box_office":
            return self._load_tmdb_list("/discover/movie", media_type="movie", page=page, params={"sort_by": "revenue.desc"})
        if sort == "oscar":
            return self._load_tmdb_list("/discover/movie", media_type="movie", page=page, params={"with_keywords": "818", "sort_by": "vote_average.desc", "vote_count.gte": 1000})
    ...
    def _load_genre_rank_media(self, media_type: str, page: int, filters: dict[str, str]) -> tuple[list[VodItem], int]:
        ...
        return self._load_tmdb_list(
            ...
            page=page,
            params={"sort_by": sort_by, "with_genres": genre_id, "with_origin_country": region, "vote_count.gte": 200 if sort_rule == "rating" else 10},
        )

    def _load_variety(self, page: int, filters: dict[str, str]) -> tuple[list[VodItem], int]:
        regions = {"all": "", "cn": "CN", "kr": "KR", "jp": "JP", "tw": "TW", "hk": "HK", "eu_us": "US|GB|DE|FR|IT|ES|CA|AU"}
    ...
    def _load_platform(self, page: int, filters: dict[str, str]) -> tuple[list[VodItem], int]:
        ...
        if category == "movie":
            ...
            return self._load_tmdb_list("/discover/movie", media_type="movie", page=page, params={"watch_region": "US", "with_watch_providers": provider_map.get(platform, ""), "sort_by": sort})
    ...
    def _load_trends(self, page: int, filters: dict[str, str]) -> tuple[list[VodItem], int]:
        ...
        if category == "china_tv":
            return self._load_tmdb_list("/discover/tv", media_type="tv", page=page, params={"sort_by": "popularity.desc", "with_original_language": "zh"})
        if category == "china_movie":
            return self._load_tmdb_list("/discover/movie", media_type="movie", page=page, params={"sort_by": "popularity.desc", "with_original_language": "zh"})
    ...
    def _load_top10(self, page: int, filters: dict[str, str]) -> tuple[list[VodItem], int]:
        ...
        provider_map = {"netflix": "8", "disney": "337", "hbo": "1899|118", "apple-tv": "350", "amazon-prime": "119"}
        region_map = {"united-states": "US", "south-korea": "KR", "taiwan": "TW", "hong-kong": "HK", "japan": "JP", "united-kingdom": "GB", "world": "US"}
        items, _total = self._load_tmdb_list(
            f"/discover/{media_type}",
            media_type=media_type,
            page=1,
            params={"watch_region": region_map.get(region, "US"), "with_watch_providers": provider_map.get(platform, "8"), "sort_by": "popularity.desc"},
        )
    ...
    def _load_external_title_source(self, page: int, source: str) -> tuple[list[VodItem], int]:
        del page, source
        return [VodItem(vod_id="global_catalog:empty", vod_name="暂无数据", vod_content="当前外部榜单暂未返回内容")], 1
...
Remove the no-longer-needed earlier `from typing import Protocol` import duplication by keeping `from typing import Any, Protocol`.

- [ ] **Step 4: Run tests to verify they pass**

Run: `uv run pytest tests/test_global_catalog_controller.py -v`
...
```bash
git add tests/test_global_catalog_controller.py src/atv_player/controllers/global_catalog_controller.py
git commit -m "feat: map global catalog tmdb lists"
```

---

### Task 3: External Title Resolution Path

**Files:**
- Modify: `src/atv_player/controllers/global_catalog_controller.py`
- Modify: `tests/test_global_catalog_controller.py`

- [ ] **Step 1: Write failing external resolution tests**
...
Run: `uv run pytest tests/test_global_catalog_controller.py -k "external_title" -v`

Expected: FAIL because `GlobalCatalogService.__init__` does not accept `external_title_loader`.

- [ ] **Step 3: Implement injected external title loader and search**

Modify `GlobalCatalogService.__init__`:
...
Replace `_load_external_title_source` and add helper methods:

```python
    def _default_external_title_loader(self, source: str, page: int, filters: dict[str, str]) -> list[tuple[str, str, str]]:
        del source, page, filters
        return []

    def _load_external_title_source(self, page: int, source: str, filters: dict[str, str] | None = None) -> tuple[list[VodItem], int]:
...
```bash
git add tests/test_global_catalog_controller.py src/atv_player/controllers/global_catalog_controller.py
git commit -m "feat: resolve global catalog external titles"
```

---

### Task 4: Built-In Tab Registration
...
Add near existing tab order tests in `tests/test_main_window_ui.py`:
...
Run: `uv run pytest tests/test_main_window_ui.py::test_main_window_places_global_catalog_after_douban -v`

Expected: FAIL because `MainWindow.__init__` does not accept `global_catalog_controller`.

- [ ] **Step 3: Register the page and built-in definitions**

In `MainWindow.__init__`, add a parameter after `douban_controller=None`:

```python
            global_catalog_controller=None,
```

After `self.douban_page = PosterGridPage(...)`, add:
...
In `_static_tab_definitions`, insert after `douban`:

```python
            _TabDefinition("global_catalog", "环球片单", self.global_catalog_page),
```

In `_builtin_tab_default_definitions`, insert after `douban`:

```python
            _BuiltinTabDefinition("global_catalog", "环球片单", self.global_catalog_page),
```

In `_apply_theme_to_children`, include `self.global_catalog_page` wherever page theme refresh lists include `self.douban_page`.

In signal setup near `self.douban_page.search_requested...`, connect the new page's generic handlers:
...
In `_handle_tab_changed`, ensure the new page loads:
...
If `_tab_key_for_widget` or related hard-coded maps include known built-in pages, add `self.global_catalog_page: "global_catalog"` matching the local style.
...
- [ ] **Step 5: Run related navigation tests**

Run: `uv run pytest tests/test_main_window_ui.py -k "tab or builtin" -v`

Expected: PASS. If existing expected tab lists fail, update only those assertions to include `环球片单` after `豆瓣电影`.

- [ ] **Step 6: Commit**

```bash
git add tests/test_main_window_ui.py src/atv_player/ui/main_window.py
git commit -m "feat: register global catalog tab"
```
...
- [ ] **Step 1: Write failing import/wiring smoke test**

Append to `tests/test_global_catalog_controller.py`:
...
Run: `uv run pytest tests/test_global_catalog_controller.py::test_global_catalog_controller_default_factory_uses_tmdb_key -v`

Expected: FAIL because `from_config_tmdb_key` is missing.

- [ ] **Step 3: Add controller factory**

Add to `GlobalCatalogController`:
...
In `src/atv_player/app.py`, add import:

```python
from atv_player.controllers.global_catalog_controller import GlobalCatalogController
```

After `douban_controller = DoubanController(self._api_client)`, add:

```python
        global_catalog_controller = GlobalCatalogController.from_config_tmdb_key(config.metadata_tmdb_api_key)
```

In the `MainWindow(...)` construction, pass:
...
Run: `uv run pytest tests/test_global_catalog_controller.py::test_global_catalog_controller_default_factory_uses_tmdb_key tests/test_main_window_ui.py::test_main_window_places_global_catalog_after_douban -v`
...
```bash
git add tests/test_global_catalog_controller.py src/atv_player/controllers/global_catalog_controller.py src/atv_player/app.py
git commit -m "feat: wire global catalog source"
```

---

### Task 6: Failure Handling and Final Verification

**Files:**
- Modify: `src/atv_player/controllers/global_catalog_controller.py`
- Modify: `tests/test_global_catalog_controller.py`

- [ ] **Step 1: Write failing HTTP failure test**
...
- [ ] **Step 2: Run test to verify failure or confirm already passing**

Run: `uv run pytest tests/test_global_catalog_controller.py::test_global_catalog_service_returns_error_item_on_tmdb_failure -v`

Expected: PASS if Task 2 already implemented the failure behavior. If it fails, implement the behavior exactly as asserted.

- [ ] **Step 3: Run focused controller and UI tests**

Run: `uv run pytest tests/test_global_catalog_controller.py tests/test_main_window_ui.py -k "global_catalog or global catalog or places_global_catalog or builtin" -v`

Expected: PASS.

- [ ] **Step 4: Run broader smoke tests**

Run: `uv run pytest tests/test_global_catalog_controller.py tests/test_douban_controller.py tests/test_plugin_manager_dialog.py -v`

Expected: PASS.

- [ ] **Step 5: Inspect diff**

Run: `git diff -- src/atv_player/controllers/global_catalog_controller.py src/atv_player/ui/main_window.py src/atv_player/app.py tests/test_global_catalog_controller.py tests/test_main_window_ui.py`

Expected: Diff only contains the new controller/service, tab registration, app wiring, and tests.

- [ ] **Step 6: Commit**

```bash
git add tests/test_global_catalog_controller.py src/atv_player/controllers/global_catalog_controller.py
git commit -m "test: cover global catalog failure handling"
```
...
- Spec coverage: Tasks 1-5 cover the `环球片单` built-in tab, seven categories, filters, TMDB-native paths, external title resolution, and app wiring. Task 6 covers failure handling and final verification. Web scraping is represented behind the external title loader seam in this first implementation, so concrete scraper expansion can happen without UI changes.
- Placeholder scan: No TBD/TODO placeholders remain. Each code step includes exact file paths and snippets.
- Type consistency: The controller uses existing `DoubanCategory`, `CategoryFilter`, `CategoryFilterOption`, and `VodItem` models. The tab key is consistently `global_catalog`; the title is consistently `环球片单`.
