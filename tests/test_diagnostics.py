...
def test_resolve_platform_display_value_formats_windows_version_and_arch(monkeypatch) -> None:
    ...
    assert diagnostics._resolve_platform_display_value() == "Windows 11 10.0.22631 (AMD64)"
