...
def test_chat_completion_appends_chat_completions_for_slash_terminated_custom_base() -> None:
    urls: list[str] = []
    ...
    assert urls == ["https://open.bigmodel.cn/api/paas/v4/chat/completions"]


def test_chat_completion_uses_explicit_chat_completions_endpoint() -> None:
    urls: list[str] = []
